...
const ABI = require("../artifacts/contracts/pictoria.sol/pictoria.json");
...
async function main() {
  ...
  const NFT = await ethers.getContractFactory("pictoria");
  const nft = await NFT.attach("0x88721ea2B44f8408d7fB59C6B4674cdAF0D969d5");
